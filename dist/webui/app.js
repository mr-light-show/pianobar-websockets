 ...
 */function g(i){return v({...i,state:!0,attribute:!1})}class Ft{constructor(){this.listeners=new Map,this.connectionListeners=[],this.isConnected=!1,this.connect()}connect(){const e=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/socket.io`;this.ws=new WebSocket(e,"socketio"),this.ws.onopen=()=>{console.log("WebSocket connected"),this.isConnected=!0,this.notifyConnectionChange(!0),this.emit("query",null)},this.ws.onmessage=n=>{try{const s=n.data;if(typeof s=="string"&&s.startsWith("2")){const o=s.substring(1),r=JSON.parse(o),l=r[0],a=r[1];console.log("Socket.IO event:",l,a);const c=this.listeners.get(l);c&&c.forEach(p=>p(a))}}catch(s){console.error("Failed to parse Socket.IO message:",s,n.data)}},this.ws.onerror=n=>{console.error("WebSocket error:",n)},this.ws.onclose=()=>{console.log("WebSocket disconnected"),this.isConnected=!1,this.notifyConnectionChange(!1)}}notifyConnectionChange(t){this.connectionListeners.forEach(e=>e(t))}onConnectionChange(t){this.connectionListeners.push(t),t(this.isConnected)}reconnect(){this.ws.readyState!==WebSocket.OPEN&&(console.log("Attempting to reconnect..."),this.ws&&this.ws.close(),this.connect())}on(t,e){this.listeners.has(t)||this.listeners.set(t,[]),this.listeners.get(t).push(e)}emit(t,e){if(this.ws.readyState===WebSocket.OPEN){const n="2"+JSON.stringify([t,e]);this.ws.send(n)}}disconnect(){this.ws.close()}}var Kt=Object.defineProperty,Xt=Object.getOwnPropertyDescriptor,at=(i,t,e,n)=>{for(var s=n>1?void 0:n?Xt(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=(n?r(t,e,s):r(s))||s);return n&&s&&Kt(t,e,s),s};let D=class extends m{constructor(){super(...arguments),this.src="",this.alt="Album Art"}render(){return this.src?f`<img src="${this.src}" alt="${this.alt}">`:f`<div class="disc-icon">
  ...
  `;at([v()],D.prototype,"src",2);at([v()],D.prototype,"alt",2);D=at([x("album-art")],D);var Zt=Object.defineProperty,Gt=Object.getOwnPropertyDescriptor,lt=(i,t,e,n)=>{for(var s=n>1?void 0:n?Gt(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=(n?r(t,e,s):r(s))||s);return n&&s&&Zt(t,e,s),s};let I=class extends m{constructor(){super(...arguments),this.current=0,this.total=0}formatTime(i){const t=Math.floor(i/60),e=i%60;return`${t}:${e.toString().padStart(2,"0")}`}get progress(){return this.total>0?this.current/this.total*100:0}render(){return f`
  ...
  `;lt([v({type:Number})],I.prototype,"current",2);lt([v({type:Number})],I.prototype,"total",2);I=lt([x("progress-bar")],I);var Yt=Object.defineProperty,te=Object.getOwnPropertyDescriptor,Et=(i,t,e,n)=>{for(var s=n>1?void 0:n?te(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=(n?r(t,e,s):r(s))||s);return n&&s&&Yt(t,e,s),s};let F=class extends m{constructor(){super(...arguments),this.playing=!1}handlePlay(){this.dispatchEvent(new CustomEvent("play"))}handleNext(){this.dispatchEvent(new CustomEvent("next"))}render(){return f`
  ...
  `;Et([v({type:Boolean})],F.prototype,"playing",2);F=Et([x("playback-controls")],F);var ee=Object.getOwnPropertyDescriptor,se=(i,t,e,n)=>{for(var s=n>1?void 0:n?ee(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(s)||s);return s};let st=class extends m{handleReconnect(){this.dispatchEvent(new CustomEvent("reconnect"))}render(){return f`
  ...
  `;ct([v({type:Number})],B.prototype,"rating",2);ct([g()],B.prototype,"menuOpen",2);B=ct([x("song-actions-menu")],B);var oe=Object.defineProperty,re=Object.getOwnPropertyDescriptor,X=(i,t,e,n)=>{for(var s=n>1?void 0:n?re(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=(n?r(t,e,s):r(s))||s);return n&&s&&oe(t,e,s),s};let M=class extends m{constructor(){super(...arguments),this.stations=[],this.currentStation="",this.menuOpen=!1,this.handleClickOutside=i=>{this.menuOpen&&!i.composedPath().includes(this)&&(this.menuOpen=!1)}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.handleClickOutside)}toggleMenu(i){i&&i.stopPropagation(),this.menuOpen=!this.menuOpen}closeMenu(){this.menuOpen=!1}handleStationClick(i){this.dispatchEvent(new CustomEvent("station-change",{detail:{station:i.id}})),this.closeMenu()}render(){return f`
      <div class="menu-popup ${this.menuOpen?"":"hidden"}">
  ...
  `;X([v({type:Array})],M.prototype,"stations",2);X([v()],M.prototype,"currentStation",2);X([g()],M.prototype,"menuOpen",2);M=X([x("stations-popup")],M);var ae=Object.defineProperty,le=Object.getOwnPropertyDescriptor,Z=(i,t,e,n)=>{for(var s=n>1?void 0:n?le(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=(n?r(t,e,s):r(s))||s);return n&&s&&ae(t,e,s),s};let N=class extends m{constructor(){super(...arguments),this.stations=[],this.currentStation="",this.rating=0}toggleTools(i){const t=this.shadowRoot.querySelector("stations-popup");t&&t.closeMenu();const e=this.shadowRoot.querySelector("song-actions-menu");e&&e.toggleMenu(i)}toggleStations(i){const t=this.shadowRoot.querySelector("song-actions-menu");t&&t.closeMenu();const e=this.shadowRoot.querySelector("stations-popup");e&&e.toggleMenu(i)}handleLove(){this.dispatchEvent(new CustomEvent("love"))}handleBan(){this.dispatchEvent(new CustomEvent("ban"))}handleTired(){this.dispatchEvent(new CustomEvent("tired"))}handleStationChange(i){this.dispatchEvent(new CustomEvent("station-change",{detail:i.detail}))}render(){return f`
  ...
  `;Z([v({type:Array})],N.prototype,"stations",2);Z([v()],N.prototype,"currentStation",2);Z([v({type:Number})],N.prototype,"rating",2);N=Z([x("bottom-toolbar")],N);var ce=Object.defineProperty,he=Object.getOwnPropertyDescriptor,y=(i,t,e,n)=>{for(var s=n>1?void 0:n?he(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=(n?r(t,e,s):r(s))||s);return n&&s&&ce(t,e,s),s};let d=class extends m{constructor(){super(...arguments),this.socket=new Ft,this.connected=!1,this.albumArt="",this.songTitle="Not Playing",this.artistName="—",this.playing=!1,this.currentTime=0,this.totalTime=0,this.volume=100,this.rating=0,this.stations=[],this.currentStation=""}connectedCallback(){super.connectedCallback(),this.setupSocketListeners(),this.setupConnectionListener()}setupConnectionListener(){this.socket.onConnectionChange(i=>{this.connected=i,i||(this.albumArt="",this.playing=!1,this.currentTime=0,this.totalTime=0)})}setupSocketListeners(){this.socket.on("start",i=>{this.albumArt=i.coverArt,this.songTitle=i.title,this.artistName=i.artist,this.totalTime=i.duration,this.playing=!0,this.rating=i.rating||0}),this.socket.on("stop",()=>{console.log("Received stop event"),this.playing=!1,this.currentTime=0,this.totalTime=0}),this.socket.on("progress",i=>{this.currentTime=i.elapsed,this.totalTime=i.duration}),this.socket.on("stations",i=>{this.stations=(Array.isArray(i)?i:[]).sort((t,e)=>t.isQuickMix?-1:e.isQuickMix?1:t.name.localeCompare(e.name))}),this.socket.on("process",i=>{console.log("Received process event:",i),i.song?(this.albumArt=i.song.coverArt||"",this.songTitle=i.song.title||"Not Playing",this.artistName=i.song.artist||"—",this.totalTime=i.song.duration||0,this.playing=i.playing||!1,this.rating=i.song.rating||0):(this.albumArt="",this.songTitle="Not Playing",this.artistName="—",this.playing=!1,this.currentTime=0,this.totalTime=0,this.rating=0),i.station&&(this.currentStation=i.station)})}handlePlayPause(){this.playing=!this.playing,this.socket.emit("action","playback.toggle")}handleNext(){this.socket.emit("action","playback.next")}handleLove(){this.socket.emit("action","song.love")}handleBan(){this.socket.emit("action","song.ban")}handleTired(){this.socket.emit("action","song.tired")}handleStationChange(i){const{station:t}=i.detail;this.socket.emit("station.change",t)}handleReconnect(){this.socket.reconnect()}render(){return f`
      <album-art 
  ...
  `;y([g()],d.prototype,"connected",2);y([g()],d.prototype,"albumArt",2);y([g()],d.prototype,"songTitle",2);y([g()],d.prototype,"artistName",2);y([g()],d.prototype,"playing",2);y([g()],d.prototype,"currentTime",2);y([g()],d.prototype,"totalTime",2);y([g()],d.prototype,"volume",2);y([g()],d.prototype,"rating",2);y([g()],d.prototype,"stations",2);y([g()],d.prototype,"currentStation",2);d=y([x("pianobar-app")],d);
